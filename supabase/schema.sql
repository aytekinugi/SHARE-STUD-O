...
-- Paylaşım: kısa linkler (yönlendirme; hedef URL herkese okunabilir)
...
-- Paylaşım: kullanıcı bulut şablonları (JSON paket; batch yine istemcide)
...
-- Guild paylaşım şablonları (üye okur; yazar kendi kaydını siler)
